...
### `rpgbuildingshouses/`
**10 files** | Style: pixel art, rpg  
RPG building and house sprites. Includes PSD source files.  
...
House and interior sprites for RPG worlds. Includes PSD source files.  
...
**627 files** | Style: cute, chibi, cartoon  
Cute/chibi-style 2D character sprites with multiple animation states. Includes PSD source files.  
...
Large bundle of 2D character sprites by Segel. Includes Spriter (SCML) animation files and PSD sources.  
...
Medieval skill and ability icons for RPG UI. Includes PSD source files.  
...
Technology and crafting skill icons for RPG UI. Includes PSD source files.  
...
Massive icon pack with 1700+ RPG game icons across many categories: weapons, armor, consumables, materials, skills, accessories.  
...
RPG inventory item icons version 1. Includes PSD source files.  
...
### `potionbottles/`
**12 files** | Style: stylized, fantasy  
Potion bottle item sprites. Includes PSD source files.  
...
RPG items icon set version 3 — equipment, consumables, and misc items.  
...
General medieval RPG asset pack — mix of tiles, props, and decorative elements.  
...
**91 files** | Style: illustrated, fantasy  
Character portrait illustrations for RPG dialogue and character screens. Includes PSD source files.  
...
**11 files** | Style: pixel art  
Pixel art house interiors and furniture sprites. Includes Aseprite source files.  
...
Decorative prop sprites for RPG world environments. Includes PSD source files.  
...
Cave and underground tileset for RPG games.  
...
Dungeon tileset with animated tiles and autotile support.  
...
Japanese-themed environment tileset.  
...
Outdoor and forest environment tileset with animated elements. Includes Aseprite source files.  
...
Grassland biome tileset for RPG worlds. Includes PSD source files.  
...
### `rpgworldsmarshland/`
**36 files** | Style: pixel art, rpg  
Marshland/swamp biome tileset for RPG worlds. Includes PSD source files.  
...
### `rpgworldssnowylands/`
**4 files** | Style: pixel art, rpg  
Snowy landscape tileset for RPG worlds. Includes PSD source files.  
...
Snow-covered forest tileset with animated elements. Includes Aseprite source files.  
...
Comprehensive tropical island asset pack — tiles, animated shorelines, boats, dolphins, cliffs, doors, and more. Includes RPGMaker MV/MZ support and Aseprite sources.  
...
Winter village asset pack — tiles, doors, animated elements, cabin/shed structures. RPGMaker MV/MZ compatible.  
...
### `rpgpixelweapons/`
**2 files** | Style: pixel art  
Small pixel art weapons sprite sheet.  
...
RPG weapon illustrations version 1 — swords, axes, bows, etc. Includes PSD source files.  
...
Sword and shield weapon/equipment sprites. Includes PSD source files.  
